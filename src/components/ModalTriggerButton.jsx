function ModalTriggerButton({
  ...
  return (
    <button
      ...
      className="z-10 flex h-10 w-14 cursor-pointer flex-col items-center text-[#7a72ad] opacity-50 transition-all duration-75 hover:opacity-100 focus:opacity-100 focus:ring-2 focus:ring-white focus:outline-none"
      style={{
