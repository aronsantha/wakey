...
function BaseModal({ isOpen, handleClose, modalTitle, children }) {
  return (
    <Dialog
      ...
      onClose={handleClose}
    >
      <DialogBackdrop className="fixed inset-0 bottom-0 cursor-pointer overflow-y-auto bg-black/20 backdrop-blur-[3px] duration-1000" />
      <div className="fixed inset-0 bottom-0 w-screen overflow-y-auto p-2">
