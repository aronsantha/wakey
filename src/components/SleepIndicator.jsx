function SleepIndicator({ heightPercent, sleepHours }) {
  return (
    <div
      className="mr-[-15px] grid w-[15px] items-center"
      aria-label={sleepHours + " " + "hours"}
    ...
    >
      ...
      <svg
        className="text-lilac/80 col-1 row-1"
        style={{
